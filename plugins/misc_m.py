...
from Zohun import bot  # FIXED: Added bot import
...
async def _(client, message):
    # FIXED: Create Emoji instance and initialize it properly
    from Zohun.helpers.emoji_logs import Emoji
    ...
    # Get custom ubot text from database
    ubot_text = await dB.get_var(client.me.id, "text_ubot") or f"{BOT_NAME}"
    ...
    if status and hasattr(status, "text"):
        ...
        if pjg <= 100:
            if client.me.is_premium:
                text = f"""
<blockquote><b>{emo.ping} status akun premium : true</b>
<b>{emo.mention} limit check : akun anda tidak dibatasi</b>
<b>{ubot_text} ubot : {bot.me.mention}</b></blockquote>

<blockquote><b>USERBOT 10K/BULAN BY @Glenzyyy</b></blockquote>
"""
            else:
                text = f"""
<blockquote><b>status akun  : beli prem dulu ya</b>
<b>limit check : akun anda tidak dibatasi</b>
<b>ubot : {bot.me.mention}</b></blockquote>
...
"""
            ...
            if client.me.is_premium:
                text = f"""
<blockquote><b>{emo.ping} status akun premium : true</b>
<b>{emo.mention} limit check : akun anda bermasalah</b> 
<b>{ubot_text} ubot : {bot.me.mention}</b></blockquote>
...
"""
                ...
                text = f"""
<blockquote><b>status akun  : beli prem dulu ya</b>
<b>limit check : akun anda bermasalah</b>
<b>ubot : {bot.me.mention}</b></blockquote>
...
async def carbon_func(client, message):
    ...
    ex = await message.reply("memproses...")
